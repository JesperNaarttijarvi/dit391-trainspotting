...
public class Main {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(tsimCommand);
			...
			System.err.println("Main method expects 3-4 arguments: Entire searchway for Lab1.map <Train1Speed> <Train2Speed> [SimulatorSpeed]");
		} catch (IOException e) {
			e.printStackTrace();
